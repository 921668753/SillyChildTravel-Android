package com.yinglan.sct.mine.mywallet.withdrawal;
...
import com.yinglan.sct.entity.mine.mywallet.withdrawal.WithdrawalBean;
import com.yinglan.sct.entity.mine.mywallet.withdrawal.WithdrawalCompleteBean;
import com.yinglan.sct.loginregister.LoginActivity;
import com.yinglan.sct.mine.mywallet.mybankcard.AddBankCardActivity;
import com.yinglan.sct.mine.mywallet.mybankcard.MyBankCardActivity;
import com.yinglan.sct.mine.mywallet.withdrawal.withdrawalresult.WithdrawalCompleteActivity;

import static com.yinglan.sct.constant.NumericConstants.REQUEST_CODE_CHOOSE_PHOTO;
import static com.yinglan.sct.constant.NumericConstants.RESULT_CODE_PRODUCT;
...
public class WithdrawalActivity extends BaseActivity implements WithdrawalContract.View {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_CODE_PRODUCT && resultCode == RESULT_OK) {
