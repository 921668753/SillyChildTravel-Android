...
public class BoutiqueLineFragment extends BaseFragment implements CollectionContract.View, BGAOnRVItemClickListener, BGARefreshLayout.BGARefreshLayoutDelegate {
    ...
    protected View inflaterView(LayoutInflater inflater, ViewGroup container, Bundle bundle) {
        ...
        return View.inflate(aty, R.layout.fragment_boutiqueline, null);
    }
