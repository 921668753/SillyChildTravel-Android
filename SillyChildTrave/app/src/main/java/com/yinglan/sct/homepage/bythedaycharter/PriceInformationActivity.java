...
public class PriceInformationActivity extends BaseActivity implements PriceInformationContract.View, BGABanner.Delegate<ImageView, String>, BGABanner.Adapter<ImageView, String> {
    ...
    private com.sillykid.app.adapter.homepage.bythedaycharter.PriceInformationViewAdapter mAdapter;

    private com.sillykid.app.entity.homepage.bythedaycharter.PriceInformationBean priceInformationBean;
    ...
    public void initData() {
        ...
        mAdapter = new com.sillykid.app.adapter.homepage.bythedaycharter.PriceInformationViewAdapter(this);
...
//        showActivity(aty, bannerDetails);
    ...
    public void getSuccess(String success, int flag) {
        ...
        if (flag == 0) {
            priceInformationBean = (com.sillykid.app.entity.homepage.bythedaycharter.PriceInformationBean) JsonUtil.getInstance().json2Obj(success, com.sillykid.app.entity.homepage.bythedaycharter.PriceInformationBean.class);
            if (priceInformationBean.getData().getPicture() != null && priceInformationBean.getData().getPicture().size() > 0) {
