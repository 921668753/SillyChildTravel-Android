package com.yinglan.sct.homepage.airporttransportation.airportpickup;
...
public class AirportPickupActivity extends BaseActivity implements AirportPickupContract.View {
    ...
    public void initWidget() {
        super.initWidget();
        ActivityTitleUtils.initToolbar(aty, getString(R.string.fillInformation), true, R.id.titlebar);
