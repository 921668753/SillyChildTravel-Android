...
public class DueDemandActivity extends BaseActivity implements DueDemandContract.View, BGABanner.Delegate<ImageView, String>, BGABanner.Adapter<ImageView, String> {
    ...
    private com.sillykid.app.adapter.homepage.boutiqueline.DueDemandViewAdapter mAdapter;
    ...
    private com.sillykid.app.entity.homepage.boutiqueline.DueDemandBean dueDemandBean;
    ...
    public void initData() {
        ...
        mAdapter = new com.sillykid.app.adapter.homepage.boutiqueline.DueDemandViewAdapter(this);
...
//        showActivity(aty, bannerDetails);
    ...
    public void getSuccess(String success, int flag) {
        if (flag == 0) {
            dueDemandBean = (com.sillykid.app.entity.homepage.boutiqueline.DueDemandBean) JsonUtil.getInstance().json2Obj(success, com.sillykid.app.entity.homepage.boutiqueline.DueDemandBean.class);
