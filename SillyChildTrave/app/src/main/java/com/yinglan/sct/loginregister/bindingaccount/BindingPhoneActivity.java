...
import com.yinglan.sct.loginregister.SelectCountryCodeActivity;
import com.yinglan.sct.loginregister.register.RegistrationAgreementActivity;
    ...
    public void widgetClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_code:
                ...
                ((BindingPhoneContract.Presenter) mPresenter).postCode(et_phone.getText().toString(), tv_countryCode.getText().toString().trim().substring(1), opt);
                break;
