...
import com.yinglan.sct.main.service.MainService;
import com.yinglan.sct.main.service.receivers.MainCallBack;
import com.yinglan.sct.main.service.receivers.MainReceiver;
import com.yinglan.sct.message.SystemMessageFragment.MessageReceiver;
import com.yinglan.sct.message.interactivemessage.imuitl.RongCloudEvent;
...
import static com.yinglan.sct.constant.StringNewConstants.MESSAGE_RECEIVED_ACTION;
...
public class MainActivity extends BaseActivity implements MainContract.View, MainCallBack {
    ...
    private LinearLayout bottombar_community;
    ...
    @BindView(id = R.id.bottombar_activity, click = true)
    private LinearLayout bottombar_activity;

    @BindView(id = R.id.img_activity)
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if (newChageIcon == 0) {
            ...
            setSimulateClick(bottombar_activity, 160, 100);
...
//        builder.statusBarDrawable = R.mipmap.ic_launcher;
    ...
    public void cleanColors(int chageIcon) {
        ...
        img_activity.setImageResource(R.mipmap.tab_activity);
        tv_activity.setTextColor(getResources().getColor(R.color.textColor));
        ...
        switch (chageIcon) {
            ...
            case 2:
                ...
                break;
            case 3:
                img_activity.setImageResource(R.mipmap.tab_activity_selected);
                tv_activity.setTextColor(getResources().getColor(R.color.fF5656Colors));
