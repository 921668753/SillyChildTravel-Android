 ...
 * 选择产品----接送机
 */
public class SelectProductAirportTransportationActivity extends BaseActivity implements SelectProductAirportTransportationContract.View, BGARefreshLayout.BGARefreshLayoutDelegate, BGAOnRVItemClickListener {
...
//        airport_id = getIntent().getIntExtra("airport_id", 0);
    ...
    private void initRecyclerView() {
        ...
        SpacesItemDecoration spacesItemDecoration = new SpacesItemDecoration(13, 11);
        //设置item之间的间隔
