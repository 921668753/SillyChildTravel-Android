...
public class IndexNewBar extends View {
    ...
    public IndexNewBar(Context context) {
        this(context, null);
    }

    public IndexNewBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public IndexNewBar(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public IndexNewBar setHeaderViewCount(int headerViewCount) {
     ...
     * @return
     */
    public IndexNewBar setSourceDatasAlreadySorted(boolean sourceDatasAlreadySorted) {
     ...
     * @return
     */
    public IndexNewBar setDataHelper(IIndexBarDataHelper dataHelper) {
    ...
    public IndexNewBar setmPressedShowTextView(TextView mPressedShowTextView) {
        this.mPressedShowTextView = mPressedShowTextView;
        return this;
    }

    public IndexNewBar setmLayoutManager(LinearLayoutManager mLayoutManager) {
     ...
     * @return
     */
    public IndexNewBar setNeedRealIndex(boolean needRealIndex) {
    ...
    public IndexNewBar setmSourceDatas(List<? extends BaseIndexPinyinBean> mSourceDatas) {
